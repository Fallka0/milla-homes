...
const copyByLocale: Record<PublicLocale, CalculatorCopy> = {
  ...
  uk: {
    deposit: "Перший внесок",
    eyebrow: "Сплануйте покупку",
    interest: "Відсоткова ставка",
    loanAmount: "Сума кредиту",
    monthly: "Орієнтовний щомісячний платіж",
    note: "Лише для орієнтиру — не є іпотечною пропозицією. Витрати на покупку — оцінка для вторинного житла у Валенсії.",
    purchaseCosts: "Витрати на покупку (≈11%)",
    term: "Термін",
    termUnit: "років",
    title: "Іпотечний калькулятор",
    upfront: "Початково (внесок + витрати)",
  },
  ru: {
