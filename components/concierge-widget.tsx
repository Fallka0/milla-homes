...
const strings: Record<PublicLocale, UIStrings> = {
  ...
  uk: {
    booked: "Заявку на перегляд надіслано — агентство підтвердить електронною поштою.",
    closeAria: "Закрити чат",
    header: "Запитайте про цей об'єкт",
    intro: "Добрий день! Я відповім на запитання про це житло та запишу вас на перегляд. Що хочете дізнатися?",
    openLabel: "Поставити запитання",
    placeholder: "Введіть ваше запитання…",
    send: "Надіслати",
    working: "Записую вас на перегляд…",
  },
  ru: {
