...
export const adminLocales: PublicLocale[] = ["en", "es", "uk", "ru"];
...
export const adminCopy: Record<PublicLocale, AdminCopy> = {
  ...
  uk: {
    accessibility: {
      title: "Щоб мамі було простіше працювати",
      body: "Адмін-панель зроблена так, щоб не потрібно було змінювати посилання вручну: всі основні дії доступні через кнопки, поля та завантаження фото.",
      items: [
        "Натисніть Нова нерухомість, щоб додати об'єкт через зрозумілу форму.",
        "Спочатку введіть назву; посилання та референс створюються автоматично.",
        "Завантажуйте фотографії з комп'ютера замість вставлення посилань.",
      ],
    },
    dashboard: {
      actions: { createFirst: "Створити перший об'єкт", newListing: "Нова нерухомість", viewPublicSite: "Відкрити сайт" },
      emptyBody: "Створіть перший об'єкт, додайте фотографії та позначте його доступним, коли він готовий для сайту.",
      emptyTitle: "Об'єктів поки немає",
      heroBody:
        "Оновлюйте сайт з одного спокійного робочого місця. Чернетки залишаються приватними, а доступні та зарезервовані об'єкти можуть з'являтися на сайті.",
      heroEyebrow: "Огляд каталогу",
      heroTitle: (count) => `${count} об'єктів у системі`,
      inquiries: {
        email: "Email",
        empty: "Тут з'являтимуться нові повідомлення клієнтів і запити на перегляд.",
        eyebrow: "Контакти клієнтів",
      ...
      listingsEyebrow: "Об'єкти",
      listingsTitle: "Керування каталогом",
      stats: {
        drafts: "Чернетки",
        draftsBody: "Приватні об'єкти в підготовці.",
        featured: "На головній",
        featuredBody: "Можуть показуватися на головній сторінці.",
        public: "Публічні",
        publicBody: "Доступні або зарезервовані.",
      },
      table: { listing: "Об'єкт", location: "Локація", price: "Ціна", status: "Статус", type: "Тип" },
    },
    form: {
      actions: { create: "Створити об'єкт", delete: "Видалити об'єкт", save: "Зберегти", viewPublicPage: "Відкрити сторінку" },
      checkboxFeatured: "Показати цей об'єкт на головній сторінці",
      editBody: "Оновіть опис, ціну, статус або галерею. Після збереження зміни з'являться на сайті.",
      editEyebrow: "Редагувати об'єкт",
      featureLabels: {
      ...
      fields: {
        availabilityEnd: "Доступно до",
        availabilityStart: "Доступно з",
        bathrooms: "Ванні кімнати",
        bedrooms: "Спальні",
        description: "Повний опис",
        features: "Особливості",
        galleryImages: "Галерея медіа",
        interior: "Площа м²",
        internalNotes: "Внутрішні нотатки",
        listingMode: "Продаж / оренда",
        location: "Локація",
        mainImage: "Головне фото",
        plot: "Ділянка м²",
        price: "Ціна продажу (EUR)",
        reference: "Референс",
        rentPrice: "Оренда від (EUR)",
        rentPricePeriod: "Період оренди",
      ...
      fieldNotes: {
        availability: "Використовується в публічному пошуку оренди за датами.",
        features: "Показуються публічно як теги об'єкта.",
        galleryImages: "Завантажте фото чи відео або вставте по одному посиланню в рядок.",
        internalNotes: "Приватні нотатки для керування. Ніколи не показуються на сайті.",
        mainImage: "Це перше фото, яке побачать покупці.",
        reference: "Створюється з назви. Можна змінити вручну.",
        rentalPeriods: "Оберіть формати оренди, які підтримує об'єкт.",
        slug: "Використовується в публічному посиланні об'єкта.",
      },
      importer: {
        body: "Вставте публічне посилання на об'єкт, і ми заповнимо форму назвою, ціною, кімнатами, описом і медіа, якщо джерело це дозволяє.",
        cta: "Імпортувати за посиланням",
        placeholder: "https://info-home.link/app/whatsapp/...",
        reset: "Очистити імпортовану чернетку",
        title: "Почати з посилання",
      },
      listingModeLabels: { both: "Продаж і оренда", rent: "Лише оренда", sale: "Лише продаж" },
      newBody: "Почніть із назви, потім додайте продаж або оренду, дати доступності, описи та фото. Позначайте доступним лише готовий об'єкт.",
      newEyebrow: "Нова нерухомість",
      newTitle: "Додати об'єкт до каталогу.",
      placeholders: {
        description: "Повний опис для сторінки об'єкта.",
        imageUrl: "Завантажте фото або вставте URL",
        internalNotes: "Побажання власника, нотатки щодо ключів, оренди чи нагадування для себе.",
        location: "Torrevieja",
        shortDescription: "Короткий абзац для карток і прев'ю.",
        title: "Стильна вілла поруч із солоними озерами",
      },
      rentPricePeriodLabels: { month: "На місяць", night: "За ніч", week: "На тиждень" },
      rentalPeriodLabels: {
    ...
    languageLabel: "Мова адмін-панелі",
    layout: {
      adminLabel: "Адмін",
      dashboard: "Панель",
      missingConfigBody: "Додайте змінні Supabase, виконайте міграції та створіть адміністратора.",
      missingConfigTitle: "Налаштування не завершено",
      newListing: "Нова нерухомість",
      signOut: "Вийти",
      title: "Керування нерухомістю",
      viewSite: "Відкрити сайт",
    },
    login: {
      body: "Додавайте об'єкти, оновлюйте ціни, позначайте резерви та підтримуйте каталог з одного місця.",
      email: "Email",
      emailPlaceholder: "admin@example.com",
      envError: "Бракує змінних оточення Supabase.",
      loginErrorFallback: "Не вдалося ввійти. Перевірте email і пароль.",
      password: "Пароль",
      privateAdmin: "Приватний адмін",
      setupBody: "Додайте змінні Supabase у `.env.local` і створіть адміністратора в Supabase Auth.",
      setupTitle: "Потрібно налаштувати адмін-панель",
      signingIn: "Вхід...",
      submit: "Увійти в адмін-панель",
      title: "Увійдіть, щоб керувати об'єктами.",
      unauthorized: "Вхід виконано, але цей email не додано в `ADMIN_EMAILS`.",
    },
    statusLabels: { available: "Доступно", draft: "Чернетка", reserved: "Заброньовано", sold: "Продано" },
    typeLabels: { apartment: "Апартаменти", bungalow: "Бунгало", finca: "Фінка", penthouse: "Пентхаус", townhouse: "Таунхаус", villa: "Вілла" },
    upload: {
      compressingImage: "Стискаємо велике зображення перед завантаженням...",
      convertingImage: "Конвертуємо HEIC-фото...",
      fileTooLarge: "Файл має бути не більшим за 50 МБ після стиснення.",
      galleryPlaceholder: "Завантажте фото чи відео або вставте по одному посиланню в рядок.",
      imagePlaceholder: "Завантажте фото або вставте URL",
      imageUploaded: "Фото завантажено.",
      uploadFailed: "Не вдалося завантажити файл.",
      uploadGallery: "Завантажити медіа",
      uploadImage: "Завантажити фото",
      uploading: "Завантаження...",
      uploadedCount: "Завантажено файлів: {count}.",
      videoTooLarge: "Відео має бути не більшим за 50 МБ. Стисніть його перед завантаженням.",
    },
  },
  de: {} as AdminCopy,
};
